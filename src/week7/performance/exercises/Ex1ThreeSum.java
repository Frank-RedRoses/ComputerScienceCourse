...
/* ***************************************************************************** 
 * 4.1.1.ThreeSum.
 * Implement the method printAll() for ThreeSum.java, which prints all of the 
 ...
 *
 ******************************************************************************/
public class Ex1ThreeSum {

    // print all distinc triples (i, j, k) such that a[i] + a[j] + a[k] = 0
    ...
    public static void main(String[] args) {
        ...
        int count = count(a);
        printAll(a);            // print all the triples that sum to zero
