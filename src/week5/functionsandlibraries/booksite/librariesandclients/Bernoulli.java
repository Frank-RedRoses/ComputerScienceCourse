package week5.functionsandlibraries.booksite.librariesandclients;

import edu.princeton.cs.algs4.StdDraw;
import edu.princeton.cs.algs4.StdRandom;
import edu.princeton.cs.algs4.StdStats;
import week5.functionsandlibraries.booksite.staticmethods.Gaussian;
...
public class Bernoulli {
    ...
    // number of heads when fliping n fair coins
    ...
    public static void main(String[] args) {
        ...
        // flip n fair coins, trial times
        int[] freq = new int[ n + 1];   // frequency of i times heads from n flips
